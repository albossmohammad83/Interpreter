...
public class Parser {
    ...
    public Statement createForStatement(
        ...
        // TODO: Implement.
        return new ForStatement(bodyStatements, loopVariableName, parseExpression(rangeStartAsString), parseExpression(rangeEndAsString));
    }
    ...
    public Expression createFunctionCallExpression(String functionName, List<String> parameterValuesAsStrings) {
        ...
        for(String paramValString: parameterValuesAsStrings){
            parameterNames.add(parseExpression(paramValString));
        }
        return new FunctionCallExpression(functionName, parameterNames);
    }
