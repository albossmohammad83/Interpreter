...
public class ProgramState {
    ...
    private HashMap<String, List<String>> parameterNames;
    private HashMap<String, List<Statement>> functionStatements;
    ...
    public void registerFunction(String functionName, List<String> parameterNames, List<Statement> functionStatements) {
        // TODO: Implement.
        this.parameterNames.put(functionName, parameterNames);
    ...
    public List<String> getParameterNames(String functionName) {
        // TODO: Implement.
        return this.parameterNames.get(functionName);
    }
